...
namespace OMSATrackingAPI.DAL.Migrations
{
    ...
    [Migration("20240412000918_FavoriteBusStop")]
    partial class FavoriteBusStop
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OMSATrackingAPI.DAL.Models.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1001,
                            CreatedBy = "Admin",
                            CreationDate = new DateTime(2024, 4, 12, 0, 9, 17, 847, DateTimeKind.Utc).AddTicks(1378),
                            IsDeleted = false,
                            Password = "Api12345",
                            Username = "Api"
                        });
            ...
            modelBuilder.Entity("OMSATrackingAPI.DAL.Models.Driver", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BusId = 1001,
                            CreatedBy = "Admin",
                            CreationDate = new DateTime(2024, 4, 12, 0, 9, 17, 852, DateTimeKind.Utc).AddTicks(2456),
                        ...
                        new
                        {
                            ...
                            BusId = 1002,
                            CreatedBy = "Admin",
                            CreationDate = new DateTime(2024, 4, 12, 0, 9, 17, 852, DateTimeKind.Utc).AddTicks(2461),
            ...
            modelBuilder.Entity("OMSATrackingAPI.DAL.Models.FavoriteBusStop", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("OMSATrackingAPI.DAL.Models.Route", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Code = "R001",
                            CreatedBy = "Admin",
                            CreationDate = new DateTime(2024, 4, 12, 0, 9, 17, 852, DateTimeKind.Utc).AddTicks(8617),
                        ...
                        new
                        {
                            ...
                            Code = "R002",
                            CreatedBy = "Admin",
                            CreationDate = new DateTime(2024, 4, 12, 0, 9, 17, 852, DateTimeKind.Utc).AddTicks(8622),
            ...
            modelBuilder.Entity("OMSATrackingAPI.DAL.Models.FavoriteBusStop", b =>
                {
                    b.HasOne("OMSATrackingAPI.DAL.Models.BusStop", "BusStop")
                        .WithMany()
